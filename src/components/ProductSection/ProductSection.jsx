...
import { storeData } from "../../utils/data/dummyData";
...
const ProductSection = () => {
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4  justify-items-center py-8 gap-4 mx-auto max-w-7xl">
